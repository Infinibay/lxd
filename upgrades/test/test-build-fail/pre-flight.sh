...
# pre-flight.sh - Pre-flight checks for test-build-fail upgrade
#
# This script performs basic checks to ensure the system is ready for upgrade.
# All checks should pass - the failure will occur during the build step.

set -e

echo "Running pre-flight checks for test-build-fail upgrade..."
