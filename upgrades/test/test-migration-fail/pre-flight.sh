...
# pre-flight.sh - Pre-flight checks for test-migration-fail upgrade
#
# This script performs basic checks to ensure the system is ready for upgrade.
# All checks should pass - the failure will occur during data migration.

set -e

echo "Running pre-flight checks for test-migration-fail upgrade..."
