...
# pre-flight.sh - Pre-flight checks for v0.3.0 upgrade
#
# This script performs checks before the upgrade begins to ensure
# the system is in a good state for upgrading.

set -e

echo "Running pre-flight checks for v0.3.0 upgrade..."

# Check 1: Verify disk space (need at least 2GB for backup)
